...
import CsvImportButton from '@/components/products/CsvImportButton';
  ...
  return (
    <div>
      <PageHeader
        ...
        actions={<div className="flex items-start gap-2"><CsvImportButton ar={ar} /><AddProductButton locale={locale} /></div>}
      />
