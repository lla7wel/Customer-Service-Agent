# EH-SYSTEM1 — Documentation Index
...
| [`QA_CHECKLIST.md`](QA_CHECKLIST.md) | Post-deploy verification checklist |
| [`TROUBLESHOOTING.md`](TROUBLESHOOTING.md) | Operator debug guide — AI failures, Meta errors, login issues, useful SQL |
| [`CHANGELOG.md`](CHANGELOG.md) | Major system changes and removed features |
| [`archive/`](archive/README.md) | Historical planning docs — not current instructions |

For deployment (env vars, migrations, Meta webhook, deploy command) see [`../DEPLOYMENT.md`](../DEPLOYMENT.md).

For a one-page system summary see [`../README.md`](../README.md).
