...
|---|---|
| [`ARCHITECTURE.md`](ARCHITECTURE.md) | System design, the durability contract, module map, failure behaviour |
...
Setup, configuration and Meta requirements live in the
